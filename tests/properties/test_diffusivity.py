...
from polykin.properties.diffusion import (
    DVMX,
    DL_Hayduk_Minhas,
    DL_Stokes_Einstein,
    DL_Wilke_Chang,
...
def test_wilke_chang():
    ...
    result = DL_Wilke_Chang(
        T=293.0, MA=106.17e-3, MB=18.0e-3, rhoA=761.0, viscB=1e-3, phi=2.6
    )
